...
@customElement('example-consumer-app-accounts')
export class ExampleConsumerAppAccounts extends RoutingMixin(LitElement) {
  static styles = css`
    :host {
      display: block;
    }
    ...
    return html` <jh-single-column-layout>
      <jh-card
        ...
        <jh-consumer-card-header
          heading="Welcome to the accounts page, ${this.user.user.given_name}!"
          slot="jh-card-header">
        </jh-consumer-card-header>
      </jh-card>
...
declare global {
  interface HTMLElementTagNameMap {
    'example-consumer-app-accounts': ExampleConsumerAppAccounts;
  }
}
